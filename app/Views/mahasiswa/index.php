...
<div class="modal fade" id="mahasiswaModal" tabindex="-1" aria-labelledby="mahasiswaModalLabel" aria-hidden="true">
  ...
  <div class="form-group">
    ...
    <input type="text" pattern="[0-9]{16}" title="Masukan 10 Angka Dan Sesuai Format" id="nim" name="nim" class ="form-control nim" placeholder="nim" required >
  </div>
  <div class="form-group">
...
<div class="modal fade" id="editModal<?= $mhs['id_mhs'];?>" tabindex="-1" aria-labelledby="edit-mahasiswaModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="form-group">
    <label>Nama Mahasiswa</label><span id="error_name" class="text-danger"></span>
    <input type="text" name="nama_mhs" class="form-control nama_mhs" value="<?= $mhs['nama_mhs'];?>" placeholder="Nama Lengkap" required>
</div>
<div class="form-group">
    <label>Tanggal Lahir</label><span id="error_name" class="text-danger"></span>
    <input type="date" name="tgl_lahir" class="form-control tgl_lahir"  value="<?= $mhs['tgl_lahir'];?>" placeholder="Tanggal Lahir" required>
</div>
<div class="form-group">
    <label>Nim</label><span id="error_name" class="text-danger"></span>
    <input type="text" pattern="[0-9]{16}" title="Masukan 10 Angka Dan Sesuai Format"  value="<?= $mhs['nim'];?>" name="nim" class="form-control nim" placeholder="nim" required>
</div>
<div class="form-group">
    <label>Nomer Telepon</label><span id="error_name" class="text-danger"></span>
    <input type="number" title="Masukan 12-13 Angka" name="no_telepon" value="<?= $mhs['no_telepon'];?>"  class="form-control no_telepon" placeholder="Nomer Yang Dapat Dihubungi" required>
</div>
<div class="form-group">
    <label>Email</label><span id="error_name" class="text-danger"></span>
    <input type="text" name="email" class="form-control email" value="<?= $mhs['email'];?>" placeholder="Email" required>
</div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
